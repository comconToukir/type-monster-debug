...
const gameOver = () => {
  ...
  const typingSpeed = (questionText.length * 60 / timeTaken).toFixed(0);
  ...
  resultModal.innerHTML += `
    ...
    <p class="mb-15">Your typing speed: <span class="bold green">${typingSpeed}</span> letter per minute</p>
